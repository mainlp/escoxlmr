...
from transformers import (AdamW, AutoConfig, AutoModelWithLMHead, AutoTokenizer, MODEL_WITH_LM_HEAD_MAPPING,
                          PreTrainedModel, PreTrainedTokenizer, WEIGHTS_NAME, get_linear_schedule_with_warmup)
...
def main():
    ...
    if args.config_name:
        ...
        raise ValueError(
                "You are instantiating a new config instance from scratch. This is not supported, but you can do it "
                "from another script, save it,"
